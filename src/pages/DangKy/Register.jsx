...
import bgNetflix from '../../assets/imgs/bg-netflix.jpg'

export default function Register() {
    return (
        <div className="min-w-screen min-h-screen flex items-center justify-center" style={{ backgroundImage: `url(${bgNetflix})` }}>
                    ...
                    <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                        ...
                        <div>
                            <div className="flex -mx-3">
                                ...
                                <div className="w-1/2 px-3 mb-5">
                                    <label htmlFor className="text-xs font-semibold px-1">Họ</label>
                                    <div className="flex">
                                        <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg" /></div>
